        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0 flex space-x-3">
              <Link to="/mods/crear" className="bg-custom-primary hover:bg-custom-primary-hover text-white flex items-center rounded-lg px-4 py-2 transition-all duration-300 shadow-md hover:shadow-lg">
