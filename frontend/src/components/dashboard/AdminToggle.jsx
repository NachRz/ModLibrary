  ...
  return (
    <div className="relative flex items-center space-x-3">
      ...
      <button
        ...
        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800 ${actualIsEnabled
      ...
      >
        <span
          className={`inline-block h-4 w-4 transform rounded-full bg-white shadow-lg transition-transform ${actualIsEnabled ? 'translate-x-6' : 'translate-x-1'
            }`}
        />
      </button>
