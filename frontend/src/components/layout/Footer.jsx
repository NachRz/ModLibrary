    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ul className="space-y-3">
          <li>
            <a href="/acerca-de" className="text-sm text-custom-detail hover:text-custom-primary transition-all duration-300 hover:translate-x-1 flex items-center group">
          ...
          <li>
            <a href="/politica-privacidad" className="text-sm text-custom-detail hover:text-custom-primary transition-all duration-300 hover:translate-x-1 flex items-center group">
              <span className="w-1.5 h-1.5 bg-custom-detail rounded-full mr-3 group-hover:bg-custom-primary transition-colors duration-300"></span>
      ...
      <div className="space-y-6">
        ...
        <ul className="space-y-3">
          <li>
            <a href="https://twitter.com/modlibrary" target="_blank" rel="noopener noreferrer" className="text-sm text-custom-detail hover:text-custom-primary transition-all duration-300 flex items-center group hover:bg-custom-detail/5 rounded-lg p-2 -m-2">
        ...
        <div className="mt-8 pt-6 border-t border-custom-detail/10">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="text-custom-detail hover:text-custom-primary transition-colors duration-300 p-2 hover:bg-custom-primary/10 rounded-lg" title="Discord">
              ...
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="text-custom-detail hover:text-custom-primary transition-colors duration-300 p-2 hover:bg-custom-primary/10 rounded-lg" title="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                </svg>
              </a>
              <a href="https://www.tiktok.com/" target="_blank" rel="noopener noreferrer" className="text-custom-detail hover:text-custom-primary transition-colors duration-300 p-2 hover:bg-custom-primary/10 rounded-lg" title="TikTok">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.53.02C13.84 0 15.14.01 16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="text-custom-detail hover:text-custom-primary transition-colors duration-300 p-2 hover:bg-custom-primary/10 rounded-lg" title="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-custom-detail hover:text-custom-primary transition-colors duration-300 p-2 hover:bg-custom-primary/10 rounded-lg" title="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-end space-x-6 text-sm">
              <a href="/terminos-servicio" className="text-custom-detail hover:text-custom-primary transition-colors duration-300">
                Condiciones de servicio
              </a>
              <span className="text-custom-detail/50">|</span>
              <a href="/politica-privacidad" className="text-custom-detail hover:text-custom-primary transition-colors duration-300">
                Política de privacidad
              </a>
            </div>
          </div>
