            ...
            <div className="flex-1 pt-8">
              <div className="flex items-start justify-between mb-4">
                ...
                <button
                  ...
                  className={`ml-4 p-3 rounded-full transition-all duration-300 ${esFavorito
      ...
      <div className="max-w-[1600px] mx-auto px-4 mt-8">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-4">
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${pestañaActiva === 'nuevo'
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${pestañaActiva === 'actualizado'
                ? 'bg-white text-gray-900'
                : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${pestañaActiva === 'tendencias'
                ? 'bg-white text-gray-900'
                : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${pestañaActiva === 'popular'
                ? 'bg-white text-gray-900'
                : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${pestañaActiva === 'sorpresa'
                ? 'bg-white text-gray-900'
                : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white'
              }`}
          >
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-4">
        ...
        <div className="mb-6">
          <p className="text-gray-400 text-sm">
            ...
            {filtroTiempo !== 'todo' && ` en ${filtroTiempo === 'hoy' ? 'hoy' :
